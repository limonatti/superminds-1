...
DATA.append({
 ...
 "words":[
  ...
  ["cousin","двоюродный брат/сестра"],["parents","родители"],["friend","друг"],["neighbour","сосед"],
  ["get up","вставать"],["have breakfast","завтракать"],["go to school","ходить в школу"],
  ["do homework","делать домашку"],["watch TV","смотреть телевизор"],["go to bed","ложиться спать"],
  ["free time","свободное время"],["best friend","лучший друг"],
 ],
...
DATA.append({
 ...
 "words":[
  ["bread","хлеб"],["milk","молоко"],["cheese","сыр"],["rice","рис"],["meat","мясо"],
  ["fish","рыба"],["egg","яйцо"],["apple","яблоко"],["tomato","помидор"],["potato","картофель"],
  ["a bottle of","бутылка"],["a packet of","пачка"],["a can of","банка (жестяная)"],["a piece of","кусок"],
  ["fry","жарить"],["boil","варить"],["bake","печь"],["fresh","свежий"],["tasty","вкусный"],["sweet","сладкий"],
 ],
...
DATA.append({
 ...
 "words":[
  ["job","работа (должность)"],["work","работа / работать"],["teacher","учитель"],["doctor","врач"],
  ["nurse","медсестра"],["driver","водитель"],["cook","повар"],["engineer","инженер"],
  ["shop assistant","продавец"],["office","офис"],["factory","завод"],["hospital","больница"],
  ["boss","начальник"],["colleague","коллега"],["salary","зарплата"],["uniform","форма"],
  ["earn","зарабатывать"],["work hard","усердно работать"],["part-time","на полставки"],["full-time","полная занятость"],
 ],
...
DATA.append({
 ...
 "words":[
  ["tall","высокий"],["short","низкий/короткий"],["young","молодой"],["old","старый"],
  ["fair hair","светлые волосы"],["dark hair","тёмные волосы"],["beard","борода"],["glasses","очки"],
  ["friendly","дружелюбный"],["shy","застенчивый"],["kind","добрый"],["clever","умный"],
  ["lazy","ленивый"],["funny","смешной"],["shirt","рубашка"],["dress","платье"],
  ["jeans","джинсы"],["shoes","обувь"],["jacket","куртка"],["hat","шляпа/шапка"],
 ],
...
DATA.append({
 ...
 "words":[
  ["school","школа"],["university","университет"],["classroom","класс"],["lesson","урок"],
  ["subject","предмет"],["teacher","учитель"],["student","ученик"],["homework","домашка"],
  ["exam","экзамен"],["test","тест"],["mark","оценка"],["timetable","расписание"],
  ["break","перемена"],["uniform","форма"],["pass","сдать"],["fail","провалить"],
  ["revise","повторять к экзамену"],["study","учиться"],["clever","умный"],["strict","строгий"],
 ],
...
DATA.append({
 ...
 "words":[
  ["football","футбол"],["basketball","баскетбол"],["tennis","теннис"],["swimming","плавание"],
  ["running","бег"],["cycling","велоспорт"],["gym","спортзал"],["team","команда"],
  ["match","матч"],["win","выигрывать"],["lose","проигрывать"],["score","забить/счёт"],
  ["healthy","здоровый"],["tired","уставший"],["ill","больной"],["fit","в форме"],
  ["exercise","упражнение/зарядка"],["train","тренироваться"],["player","игрок"],["coach","тренер"],
 ],
...
DATA.append({
 ...
 "words":[
  ["holiday","отпуск/каникулы"],["trip","поездка"],["plane","самолёт"],["train","поезд"],
  ["bus","автобус"],["ferry","паром"],["airport","аэропорт"],["ticket","билет"],
  ["passport","паспорт"],["luggage","багаж"],["hotel","отель"],["tourist","турист"],
  ["beach","пляж"],["map","карта"],["abroad","за границей"],["journey","путешествие/дорога"],
  ["book","бронировать"],["pack","паковать"],["visit","посещать"],["arrive","прибывать"],
 ],
...
DATA.append({
 ...
 "words":[
  ["mountain","гора"],["river","река"],["lake","озеро"],["sea","море"],
  ["forest","лес"],["island","остров"],["desert","пустыня"],["field","поле"],
  ["animal","животное"],["bird","птица"],["fish","рыба"],["insect","насекомое"],
  ["sunny","солнечно"],["rainy","дождливо"],["windy","ветрено"],["cloudy","облачно"],
  ["snow","снег"],["storm","шторм/гроза"],["weather","погода"],["temperature","температура"],
 ],
