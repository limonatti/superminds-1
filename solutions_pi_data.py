...
DATA.append({
 ...
 "listen2_title":"Interview: How do you deal with stress?",
 "names2":{"m":"Presenter","f":"Dr Hill"},
 "dialog2":[
  ...
  ["m","What can people do when they feel worried?"],
  ["f","First, talk to someone. When you share a problem, you feel better immediately."],
  ["m","And if you're really stressed before a test?"],
  ["f","Breathe slowly, go for a short walk, and get enough sleep. A tired brain feels everything more strongly."],
  ["m","Great advice. Any last tip?"],
 ...
 "lq2":[
  ...
  {"q":"According to Dr Hill, is feeling nervous normal?","o":["yes, completely","no, never","only for adults"],"a":0},
  {"q":"What should you do first when worried?","o":["talk to someone","stay silent","eat sweets"],"a":0},
  {"q":"What does a tired brain do?","o":["feels everything more strongly","works better","stops feeling"],"a":0},
